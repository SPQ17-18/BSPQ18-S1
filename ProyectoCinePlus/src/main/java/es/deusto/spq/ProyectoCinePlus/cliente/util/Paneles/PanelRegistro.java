...
public class PanelRegistro extends JPanel {
	...
	private void registrarUsuario() {
		...
		if (nombreUser.equals("") && contra.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "NO HAS INTRODUCIDO NINGUNA CONTRASE�A NI CORREO", "ERROR!",
					JOptionPane.ERROR_MESSAGE);
		} else if (contra.equals("")) {
			JOptionPane.showMessageDialog(null, "NO HAS INTRODUCIDO NINGUNA CONTRASE�A", "ERROR!",
					JOptionPane.ERROR_MESSAGE);
			...
			JOptionPane.showMessageDialog(null, "NO HAS INTRODUCIDO NINGUN NOMBRE DE USUARIO NI CORREO NI CONTRASENYA",
					"ERROR!", JOptionPane.ERROR_MESSAGE);
